  ...
  constructor () {
    ...
    this.state = {
      ...
      risk_factor_columns: [
            ...
            {
              Header: 'Has the physical violence increased in severity or frequency over the past year?',
              accessor: 'risk_factor_id.violence_increased',
            },
            {
              Header: 'Have you left him/her after living together in the past year?',
            ...
            {
              Header: 'Has he/she used a weapon against you or threatened you with a lethal weapon?',
            ...
            {
              Header: 'Has he/she ever forced you to have sex when you did not wish to do so?',
            ...
            {
              Header: 'Does he/she spy on you, leaving threatening notes or messages?',
  ...
  render () {
    return (
      <div>
        ...
        <Table columns={this.state.risk_factor_columns} data={this.state.cases} />
        <p>Outcomes Tab</p>
