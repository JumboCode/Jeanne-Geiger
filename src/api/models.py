...
class RiskFactors(models.Model):
    ...
    violence_increased = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    attempted_leaving = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    control_activites = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    attempted_murder = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    threatened_murder = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    weapon_threat = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    attempted_choke = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    multiple_choked = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    killing_capable = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    owns_gun = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    suicide_threat_or_attempt = models.BooleanField(default=NULL, choices=BOOL_W_NA)
    is_unemployed = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    avoided_arrest = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    unrelated_child = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    uses_illegal_drugs = models.BooleanField(default=NULL, choices=BOOL_W_NA)
    is_alcoholic = models.BooleanField(default=NULL, choices=BOOL_W_NA)
    forced_sex = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    constantly_jealous = models.BooleanField(default=NULL, choices=BOOL_W_NA)
    pregnant_abuse = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
    children_threatened = models.BooleanField(default=NULL, choices=BOOL_W_NA)
    has_spied = models.NullBooleanField(default=NULL, choices=BOOL_W_NA)
