...
class RiskFactors(models.Model):
    ...
    suicide_threat_or_attempt = models.BooleanField(null=True, default=None, choices=BOOL_W_NA)
    ...
    uses_illegal_drugs = models.BooleanField(null=True, default=None, choices=BOOL_W_NA)
    is_alcoholic = models.BooleanField(null=True, default=None, choices=BOOL_W_NA)
    forced_sex = models.BooleanField(null=True, default=None, choices=BOOL_W_NA)
    constantly_jealous = models.BooleanField(null=True, default=None, choices=BOOL_W_NA)
    pregnant_abuse = models.BooleanField(null=True, default=None, choices=BOOL_W_NA)
    children_threatened = models.BooleanField(null=True, default=None, choices=BOOL_W_NA)
